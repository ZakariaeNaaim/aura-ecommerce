...
export class AuthService {
  ...
  register(user:AuraUser): Observable<boolean> {
    return this.http.post<boolean>(`${this.baseUrl}/signup`, user);
  }


  public login(user: { username: string, email: string, password: string }): Observable<{ 'token': string }> {
    const options = {
